...
// Configurar acceso a archivos estáticos desde player_images
var playerImagesPath = Path.Combine(builder.Environment.ContentRootPath, "player_images");
if (Directory.Exists(playerImagesPath))
{
    app.UseStaticFiles(new StaticFileOptions
    {
        FileProvider = new Microsoft.Extensions.FileProviders.PhysicalFileProvider(playerImagesPath),
        RequestPath = "/player_images"
    });
}
